...
import CustomColumnDefinition from './CustomColumnDefinition'

class CustomRowDefinition extends React.Component {
    render() {
        return null
    }
}

CustomRowDefinition.propTypes = {
...
export default CustomColumnDefinition
