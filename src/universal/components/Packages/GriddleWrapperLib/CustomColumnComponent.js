...
class CustomColumnComponent extends React.Component {
    ...
    shouldComponentUpdate(nextProps) {
        if (this.props.Store.get('contactTable').selectedColumns !== nextProps.Store.get('contactTable').selectedColumns) {
            //console.log('update-column-columntoggle')
            return true
        }
...
CustomColumnComponent.defaultProps = {
    columnProperties: {
        cssClassName: ''
    }
}
